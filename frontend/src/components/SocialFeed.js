...
const MediaLiteracyPlatform = () => {
  ...
  const sections = [
    ...
    { id: 'case-studies', name: 'Case Studies', icon: BookOpen, color: 'orange' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <AnimatePresence mode="wait">
          ...
          {activeSection === 'case-studies' && <CaseStudies key="cases" />}
        </AnimatePresence>
      </div>
    </div>
  );
...
const CaseStudies = () => {
  ...
  const [cases] = useState([
    {
      id: 1,
      title: 'The COVID-19 Miracle Cure Hoax',
      category: 'Health Misinformation',
      date: 'March 2023',
      impact: 'High',
      summary: 'False claims about a simple home remedy curing COVID-19 spread rapidly through social media.',
      details: {
        origin: 'Started on a health blog, amplified through WhatsApp groups',
        spread: 'Reached 5 million people across 15 countries in 48 hours',
        damage: 'Led to several hospitalizations from dangerous self-medication',
        resolution: 'Debunked by WHO and major health organizations',
        lessons: [
          'Health claims without scientific backing spread fastest during crises',
          'Personal testimonials are more convincing than statistics to many people',
          'Urgent-sounding language triggers faster sharing'
        ]
      },
      timeline: [
        { time: 'Hour 0', event: 'Original blog post published' },
        { time: 'Hour 6', event: 'First shares on Facebook and WhatsApp' },
        { time: 'Hour 24', event: 'Video testimonial goes viral on TikTok' },
        { time: 'Hour 48', event: 'Mainstream media picks up story' },
        { time: 'Hour 72', event: 'Official health organizations respond' }
      ]
    },
    {
      id: 2,
      title: 'The Deepfake Political Scandal',
      category: 'Political Manipulation',
      date: 'January 2024',
      impact: 'Critical',
      summary: 'AI-generated video showed a political figure making inflammatory statements.',
      details: {
        origin: 'Sophisticated deepfake created by unknown actors',
        spread: 'Shared 2.3 million times before detection',
        damage: 'Influenced polling numbers and public opinion significantly',
        resolution: 'Detected by AI analysis tools and forensic experts',
        lessons: [
          'Deepfakes are becoming harder to detect with naked eye',
          'Political content spreads faster during election periods',
          'Technical verification tools are essential for media literacy'
        ]
      },
      timeline: [
        { time: 'Day 1', event: 'Deepfake video first uploaded' },
        { time: 'Day 2', event: 'Video goes viral on multiple platforms' },
        { time: 'Day 3', event: 'Traditional media reports on the controversy' },
        { time: 'Day 4', event: 'Technical experts identify deepfake markers' },
        { time: 'Day 5', event: 'Platforms remove content and issue warnings' }
      ]
    }
  ]);
  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border">
        ...
        <p className="text-gray-600">Learn from real-world examples of misinformation campaigns</p>
      </div>
        ...
        >
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center space-x-4 text-sm text-gray-600">
                  <span className="bg-orange-100 text-orange-700 px-2 py-1 rounded-full">{selectedCase.category}</span>
                  <span>{selectedCase.date}</span>
                  <span className={`px-2 py-1 rounded-full ${
                    selectedCase.impact === 'Critical' ? 'bg-red-100 text-red-700' :
                    selectedCase.impact === 'High' ? 'bg-orange-100 text-orange-700' :
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600">{selectedCase.summary}</p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {selectedCase.details.timeline.map((item, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-sm font-medium min-w-[80px]">
                      {item.time}
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">Origin & Spread</h4>
                <div className="space-y-2 text-sm">
                  <p><strong>Origin:</strong> {selectedCase.details.origin}</p>
                  <p><strong>Spread:</strong> {selectedCase.details.spread}</p>
                </div>
              </div>
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">Impact & Resolution</h4>
                <div className="space-y-2 text-sm">
                  <p><strong>Damage:</strong> {selectedCase.details.damage}</p>
                  <p><strong>Resolution:</strong> {selectedCase.details.resolution}</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {selectedCase.details.lessons.map((lesson, index) => (
          ...
          {cases.map((caseStudy) => (
            ...
            >
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <h3 className="font-bold text-lg text-gray-900 mb-2">{caseStudy.title}</h3>
                ...
                <div className="flex items-center justify-between">
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                    caseStudy.impact === 'Critical' ? 'bg-red-100 text-red-700' :
                    caseStudy.impact === 'High' ? 'bg-orange-100 text-orange-700' :
                    'bg-yellow-100 text-yellow-700'
                  }`}>
