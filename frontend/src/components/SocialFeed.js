...
const MediaLiteracyPlatform = () => {
  const [activeSection] = useState('community-reports');
    ...
    try {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.log('âœ… Report submitted to backend successfully');
        } else {
          throw new Error(`Backend error: ${response.status}`);
        }
      } catch (backendError) {
        console.warn('âš ï¸ Backend submission failed, using local storage:', backendError.message);
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-blue-800 space-y-1">
                        <li>â€¢ Only submit content you believe may be false or misleading</li>
                        <li>â€¢ Provide clear reasons why you think the content is suspicious</li>
                        <li>â€¢ Do not submit content that violates privacy or contains personal information</li>
                        <li>â€¢ Your submission will be reviewed by community moderators</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-medium text-blue-900 mb-2">ðŸ” Analysis Tips</h4>
                      <ul className="text-sm text-blue-800 space-y-1">
                        <li>â€¢ Look for inconsistent lighting or shadows</li>
                        <li>â€¢ Check for unnatural edges or blending</li>
                        <li>â€¢ Examine facial features for distortions</li>
                        <li>â€¢ Consider the source and context</li>
                      </ul>
                    </div>
                  </div>
...
const TrendingAlerts = () => {
  ...
  const [filter, setFilter] = useState('all');
  const [sortBy] = useState('severity');
                ...
                <div className="space-y-4">
                  ...
                  {selectedAlert.realDetails.factCheckSources && (
                    <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                      <h3 className="font-semibold text-green-900 mb-2">âœ… Verified By</h3>
